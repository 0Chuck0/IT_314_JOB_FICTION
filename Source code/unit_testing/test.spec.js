...
// chai.should();
// chai.use(chaiHttp);
// describe("Testing route company/Admin/changepassword", () => {
//   const host = `http://localhost:3000`;
//   const path = `/Admin/changepassword`;


//   it("Invalid currentpassword formate.", (done) => {
//     chai
//       .request(host)
//       .post(path)
//       .send({
//         currentpassword:'abcd@9875',
//         Newpassword:'Abcd@9876',
//         conforimpassword:'Abcd@9876'
//       })
//       .end(function (err, res, body) {
//         console.log(res)
//         res.status.should.equal(400);
...
//   it("Invalid Newpassword formate.", (done) => {
//     chai
//       .request(host)
//       .post(path)
//       .send({
...
//   it("Invalid confirmpassword formate.", (done) => {
//     chai
//       .request(host)
//       .post(path)
//       .send({
...
//   it("Newpassword and confirmpassword are not matching.", (done) => {
//     chai
//       .request(host)
//       .post(path)
//       .send({
...
//       .send({
//         currentpassword:'abcd@9875',
//         Newpassword:'Abcd@9877',
//         conforimpassword:'Abcd@9878'
//       })
//       .end(function (err, res, body) {
//         console.log(res)
//         res.status.should.equal(400);
...
//   it("currentpassword cannot be empty.", (done) => {
//     chai
//       .request(host)
//       .post(path)
//       .send({
...
//   it("Newpassword cannot be empty.", (done) => {
//     chai
//       .request(host)
//       .post(path)
//       .send({
...
//   it("confirmpassword cannot be empty.", (done) => {
//     chai
//       .request(host)
//       .post(path)
//       .send({
...
//       .send({
//         currentpassword:'Abcd@9875',
//         Newpassword:'Pkliy$%9875',
//         conforimpassword:'Pkliy$%9875'
//       })
//       .end(function (err, res, body) {
//         console.log(res)
//         res.status.should.equal(400);
...
//       .send({
//         currentpassword:'Abcd@9875',
//         Newpassword:'Jinal$98745',
//         conforimpassword:'Jinal$98745'
//       })
//       .end(function (err, res, body) {
//         console.log(res)
//         res.status.should.equal(400);
...
chai.should();
chai.use(chaiHttp);
describe("Testing route company/Admin/register", () => {
  const host = `http://localhost:3000`;
  const path = `/Admin/register`;


  it("Name must be between 3 and 50 characters.", (done) => {
    chai
      .request(host)
      .post(path)
      .send({
        newname:'jo',
        newemail:'jinalgajera8900@gmail.com',
        password:'Jinal@123'
      })
      .end(function (err, res, body) {
        console.log(res)
  ...
  it("Name must be between 3 and 50 characters.", (done) => {
    chai
      ...
      .post(path)
      .send({
        newname:'jinalhdjwuqyepdnabxjdegsjjijijijkjkjfkldjsdkljkdjfdskljlkfjlsfjfdjhsdkjhesi',
        newemail:'jinalgajera8900@gmail.com',
        password:'Jinal@123'
      })
      .end(function (err, res, body) {
  ...
  it("Name must be between 3 and 50 characters.", (done) => {
    chai
      ...
      .post(path)
      .send({
        newname:'xcusdhjgjfdgureyuyriuyuieryureyruiyuhfdhgjfkhdfgkjhruituryeurihgj',
        newemail:'jinalgajera8900@gmail.com',
        password:'Jinal@123'
      })
      .end(function (err, res, body) {
  ...
  it("Invalid email formate. Uppercase letters are not allowed in the local part.", (done) => {
    chai
      .request(host)
      .post(path)
      .send({
        newname:'Jinal Gajera',
        newemail:'JinalGajera8900@gmail.com',
        password:'Jinal@123'
      })
      .end(function (err, res, body) {
  ...
  it("Invalid email formate.", (done) => {
    chai
      .request(host)
      .post(path)
      .send({
        newname:'Jinal Gajera',
        newemail:'jinalgajera8900',
        password:'Jinal@123'
      })
      .end(function (err, res, body) {
        console.log(res)
  ...
  it("Invalid password formate.", (done) => {
    chai
      .request(host)
      .post(path)
      .send({
  ...
  it("paaword cannot be empty.", (done) => {
    chai
      .request(host)
      .post(path)
      .send({
  ...
  it("All valid Field", (done) => {
    chai
      ...
      .send({
        newname:'jinalgajera',
        newemail:'jinalgajera7604@gmail.com',
        password:'Jinalg@123'
      })
      .end(function (err, res, body) {
        console.log(res)
